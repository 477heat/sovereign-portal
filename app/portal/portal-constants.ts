...
export const plainEnglishCertificateSummary = [
  ...
  "The formal contract makes a huge theatrical joke about afterlife ownership and eternal servitude. It is supposed to feel comically intense. Part of the joke is also a warning: do not casually sell this like a random generic drop, because it is also an access token for the project.",
